...
function Home() {
    ...
    function incPageNumber() {
        setpageNumber(function (pageNo) {  //if we pass function in a parameter section of setPageNo , then we can pass prevState in inner function due to which there will be no mismatch during frequent state change
            return pageNo + 1;
        });
    }
    ...
    return (
        <>
            <Header></Header>
            <Banner></Banner>
            <MovieList pageNo={pageNo}></MovieList>   {/* passing page no to    movie list */}
